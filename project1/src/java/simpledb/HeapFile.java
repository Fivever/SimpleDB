...
public class HeapFile implements DbFile {
    ...
    public Page readPage(PageId pid)
    {
        ...
        try {
            ...
            int start = pid.pageNumber()*BufferPool.PAGE_SIZE;
            byte[] data = new byte[BufferPool.PAGE_SIZE];
            file.seek(start);
            file.read(data,0,BufferPool.PAGE_SIZE);
            file.close();
    ...
    public class HeapFileIterator implements DbFileIterator
    {
        ...
        {
            this.pgNo = 0;
            this.page = (HeapPage) Database.getBufferPool().getPage(tid, new HeapPageId(f.getId(),pgNo), Permissions.READ_ONLY);
